...
def primary_action_handler():
    ...
    elif contains(game_info.own_cards, Character.Assassin) and game_info.balances[bot_battle.player_id] >= 3:
        target_player_id = get_next_alive_player()
...
# Always challenge - we want to validate whether challenges can be successfully
# completed
